package nl.kristalsoftware.association.team.datastore.member.messaging;
...
public class MemberDomainEventConsumer extends EventConsumer<MemberEventData> {
    ...
    @Transactional
    @KafkaListener(topics = "${team.kafka.member.topicname}")   //, containerFactory = "playerKafkaListenerContainerFactory")
